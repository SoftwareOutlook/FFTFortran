...
Looking at all the data in Table~\ref{Tbl:FFTW2d256}, we see that when
...
$N=256$ with complex input signals, from Table~\ref{Tbl:FFTW2d256c} we
...
For $N=257,$ we see from Table~\ref{Tbl:FFTW2d257} that for both the
